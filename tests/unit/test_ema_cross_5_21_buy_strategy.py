...
Full spec: strategies/intraday_options/ema_cross_5_21_buy/ema_cross_5_21_buy_spec.md.
...
``tests/integration/test_ema_cross_5_21_buy_engine.py`` instead.
...
``test_ema_cross_9_21_buy_strategy.py``/``test_ema_cross_5_9_buy_strategy.py``
...
# ------------------------------------------------------------- 1. registration
def test_strategy_registers_as_ema_cross_5_21_buy():
    assert "ema_cross_5_21_buy" in available_strategies()
    assert EmaCross5x21BuyStrategy.name == "ema_cross_5_21_buy"
...
def test_get_strategy_by_name_builds_from_cfg_parameters():
    ...
    strategy = get_strategy("ema_cross_5_21_buy", _Cfg())
