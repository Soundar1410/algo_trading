"""Negative space: ``st05_supertrend_buy`` must never appear as a code branch in
...
_LITERAL_RE = re.compile(r"""["']st05_supertrend_buy["']""")
...
def test_no_generic_module_contains_the_strategy_id_as_a_literal():
    ...
    assert offenders == {}, (
        f"generic infrastructure names 'st05_supertrend_buy' as a literal at: "
